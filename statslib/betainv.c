 ...
 * SYNOPSIS:
*
 * double a, b, x, y, beta_distribution_inv();
*
...
extern double normal_distribution_inv(double y0);
double beta_distribution_inv(double aa,double bb,double yy0 )
{
...
ihalve:
	...
	//mtherr( "beta_distribution_inv", EPLOSS );
	if( x0 >= 1.0 )
	{
		x0 = 1.0 - LDBL_EPSILON;
		goto done;
