...
#define CBRT2 1.2599210498948731647672106
#define CBRT4 1.5874010519681994747517056
#define CBRT2I 0.793700525984099737375852
#define CBRT4I 0.629960524947436582383605
...
void qcbrt(Qfloatp xx,Qfloatp y)
{
	...
	*/
	...
	/* Newton iterations. */
	x -= ( x - (z/(x*x)) )*0.33333333333333333333333;
	x -= ( x - (z/(x*x)) )*0.33333333333333333333333;
	x -= ( x - (z/(x*x)) )*0.33333333333333333333333;
	x -= ( x - (z/(x*x)) )*0.33333333333333333333333;
