...
*/
long double binomial_c(int k,int n,long double p )
{
	long double dk, dn;
...
#ifdef __LCC__
long double __declspec(naked) binomial_inv(int k,int n,long double y )
{
}
#endif
...
#ifndef __LCC__
long double binomial_inv(int k,int n,long double y )
{
	return bdtril(k,n,y);
}
#endif
